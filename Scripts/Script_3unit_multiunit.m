...
% Script for the analysis of a 3-unit Networking DCMG
...
%eig_unb = [eigenvalues(1:(end-3),1),eigenvalues(1:(end-3),end)]
%csvwrite('eig_unb.csv',eig_unb);
eig_b = [eigenvalues(1:(end-3),1),eigenvalues(1:(end-3),end)]
csvwrite('eig_b.csv',eig_b);
